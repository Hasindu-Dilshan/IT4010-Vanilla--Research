...
import FlowerRoute from "../../routes/flower/flower";
...
import FlowerContainer from "../flower-container/flowerContainer";
  ...
  return (
    <div className="container backg">
      ...
      <Routes>
        ...
        <Route path="/flower" element={<FlowerRoute />}>
          <Route path="" element={<FlowerContainer />} />
          {/* <Route path="upload" element={<UploadContainer />} /> */}
        </Route>
